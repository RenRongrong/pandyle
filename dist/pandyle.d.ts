...
declare namespace Pandyle {
    class Inputs {
        ...
        private initData_radio(element);
        private initData_check(element);
        private initData_normal(element);
        private initData_select(element);
        private bindChange();
        private onChange_normal(element);
        private onChange_input(element);
        private onChange_radio(element);
        private onChange_check(element);
        private onChange_select(element);
